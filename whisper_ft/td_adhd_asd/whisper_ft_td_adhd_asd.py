...
class LoggingCallback(TrainerCallback):
    ...
    def on_log(self, args, state, control, logs=None, **kwargs):
        ...
        try:
            ...
            plt.legend()
            plt.tight_layout()
            plt.savefig("/scratch/s5910587/whisper_ft/td_adhd_asd/train_log.png")
            plt.close()
...
training_args = Seq2SeqTrainingArguments(
    output_dir="/scratch/s5910587/whisper_ft/td_adhd_asd/model",
...
trainer = Seq2SeqTrainer(
    ...
    callbacks=[LoggingCallback("/scratch/s5910587/whisper_ft/td_adhd_asd/train_log.tsv")], # 只保留日志回调
)
...
model.save_pretrained("/scratch/s5910587/whisper_ft/td_adhd_asd/final_model")
processor.save_pretrained("/scratch/s5910587/whisper_ft/td_adhd_asd/final_processor")

# === 保存最终训练结果 ===
final_metrics = trainer.state.log_history[-1]
import json
with open("/scratch/s5910587/whisper_ft/td_adhd_asd/final_metrics.json", "w", encoding="utf-8") as f:
