...
# === 路径设置 ===
SEGMENTS_TRAIN_DIR = "/scratch/s5910587/data_asd/segments"
GT_TRAIN_DIR = "/scratch/s5910587/data_asd/GT"
...
class LoggingCallback(TrainerCallback):
    ...
    def on_log(self, args, state, control, logs=None, **kwargs):
        ...
        try:
            ...
            plt.legend()
            plt.tight_layout()
            plt.savefig("/scratch/s5910587/whisper_ft/asd_only_lora_5000/train_log.png")
            plt.close()
        except Exception as e:
...
training_args = Seq2SeqTrainingArguments(
    output_dir="/scratch/s5910587/whisper_ft/asd_only_lora_5000/model",
...
trainer = Seq2SeqTrainer(
    ...
    callbacks=[LoggingCallback("/scratch/s5910587/whisper_ft/asd_only_lora_5000/train_log.tsv")], # 只保留日志回调
)
...
model.save_pretrained("/scratch/s5910587/whisper_ft/asd_only_lora_5000/final_model")
processor.save_pretrained("/scratch/s5910587/whisper_ft/asd_only_lora_5000/final_processor")

# === 保存最终训练结果 ===
final_metrics = trainer.state.log_history[-1]
import json
with open("/scratch/s5910587/whisper_ft/asd_only_lora_5000/final_metrics.json", "w", encoding="utf-8") as f:
